...
"""
Build Model and define some hyper-params
"""
vocab_size += 1
...
"""
Training and print train and test accuracy
"""
for epoch in range(no_of_epochs):
    ...
    print("Train Accuracy:", "%.2f" % (epoch_acc*100.0), "Train Loss:", "%.4f" % epoch_loss, "Time Elapsed:", "%.4f" % float(time.time()-time1))
    # ## test
    if((epoch+1)%2)==0:
        # do testing loop
        model.eval()
